...
struct folio* bpf_cache_ext_list_pop(u64 list, bool tail) __ksym;
...
u64 bpf_cache_ext_folio_to_handle(struct folio* folio, u64 secret_key) __ksym;
u64 bpf_cache_ext_memcg_to_handle(struct mem_cgroup* memcg, u64 secret_key) __ksym;
u64 bpf_cache_ext_ctx_to_handle(struct cache_ext_eviction_ctx* ctx, u64 secret_key) __ksym;
...
struct cache_ext_val_buffer* bpf_cache_ext_map_lookup(struct bpf_map* map, void* key, u32 key__sz) __ksym;
int bpf_cache_ext_map_set_u64(struct bpf_map* map, void* key, u32 key__sz, u32 offset, long long value) __ksym;
int bpf_cache_ext_map_set_u32(struct bpf_map* map, void* key, u32 key__sz, u32 offset, u32 value) __ksym;
int bpf_cache_ext_map_set_bool(struct bpf_map* map, void* key, u32 key__sz, u32 offset, bool value) __ksym;
long long bpf_cache_ext_map_inc(struct bpf_map* map, void* key, u32 key__sz,
